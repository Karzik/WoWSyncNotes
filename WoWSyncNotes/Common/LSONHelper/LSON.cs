...
namespace WoWSyncNotes.Common.LSONHelper;
...
class LsonParserState
{
    ...
    private LSONOffsetToLineCol _offsetConverter;
    public LSONOffsetToLineCol OffsetConverter { get { if (_offsetConverter == null) _offsetConverter = new LSONOffsetToLineCol(Lson); return _offsetConverter; } }
...
public abstract class LsonValue : DynamicObject, IEquatable<LsonValue>
{
    ...
    protected virtual LsonDict getDict(bool safe) { return safe ? null : LSONUtil.Throw<LsonDict>(new InvalidOperationException("Only dict values can be converted to dict.")); }
    ...
    /// <param name="safe">
    ///     Controls the behavior in case of conversion failure. If true, returns null; if false, throws.</param>
    protected virtual string getString(StringConversionOptions options, bool safe) { return safe ? null : LSONUtil.Throw<string>(new InvalidOperationException("Only string values can be converted to string.")); }
    ...
    /// <param name="safe">
    ///     Controls the behavior in case of conversion failure. If true, returns null; if false, throws.</param>
    protected virtual bool? getBool(BoolConversionOptions options, bool safe) { return safe ? null : LSONUtil.Throw<bool?>(new InvalidOperationException("Only bool values can be converted to bool.")); }
    ...
    /// <param name="safe">
    ///     Controls the behavior in case of conversion failure. If true, returns null; if false, throws.</param>
    protected virtual double? getDouble(NumericConversionOptions options, bool safe) { return safe ? null : LSONUtil.Throw<double?>(new InvalidOperationException("Only numeric values can be converted to double.")); }
    ...
    /// <param name="safe">
    ///     Controls the behavior in case of conversion failure. If true, returns null; if false, throws.</param>
    protected virtual decimal? getDecimal(NumericConversionOptions options, bool safe) { return safe ? null : LSONUtil.Throw<decimal?>(new InvalidOperationException("Only numeric values can be converted to decimal.")); }
    ...
    /// <param name="safe">
    ///     Controls the behavior in case of conversion failure. If true, returns null; if false, throws.</param>
    protected virtual long? getLong(NumericConversionOptions options, bool safe) { return safe ? null : LSONUtil.Throw<long?>(new InvalidOperationException("Only numeric values can be converted to long.")); }
    ...
    /// <param name="safe">
    ///     Controls the behavior in case of conversion failure. If true, returns null; if false, throws.</param>
    protected virtual int? getInt(NumericConversionOptions options, bool safe) { return safe ? null : LSONUtil.Throw<int?>(new InvalidOperationException("Only numeric values can be converted to int.")); }
...
public sealed class LsonString : LsonValue, IEquatable<LsonString>
{
    ...
    protected override double? getDouble(NumericConversionOptions options, bool safe)
    {
        ...
        if (double.IsNaN(result) || double.IsInfinity(result))
            return safe ? null : LSONUtil.Throw<double?>(new InvalidOperationException("This string cannot be converted to a double because LSON doesn't support NaNs and infinities."));
    ...
    protected override int? getInt(NumericConversionOptions options, bool safe)
    {
        ...
        else
        {
            ...
            if (result != decimal.Truncate(result))
                return safe ? null : LSONUtil.Throw<int?>(new InvalidOperationException("String must represent an integer, but \"{0}\" has a fractional part.".Fmt(_value)));
    ...
    protected override long? getLong(NumericConversionOptions options, bool safe)
    {
        ...
        else
        {
            ...
            if (result != decimal.Truncate(result))
                return safe ? null : LSONUtil.Throw<long?>(new InvalidOperationException("String must represent an integer, but \"{0}\" has a fractional part.".Fmt(_value)));
...
public sealed class LsonNumber : LsonValue, IEquatable<LsonNumber>
{
    ...
    protected override int? getInt(NumericConversionOptions options, bool safe)
    {
        if (double.IsNaN(_double))
        {
            if (_long < int.MinValue || _long > int.MaxValue)
                return safe ? null : LSONUtil.Throw<int?>(new InvalidCastException("Cannot cast to int because the value exceeds the representable range."));
            return (int)_long;
        }

        if (!options.HasFlag(NumericConversionOptions.AllowTruncation) && _double != Math.Truncate(_double))
            return safe ? null : LSONUtil.Throw<int?>(new InvalidCastException("Only integer values can be converted to int."));
    ...
    protected override long? getLong(NumericConversionOptions options, bool safe)
    {
        ...
        if (!options.HasFlag(NumericConversionOptions.AllowTruncation) && _double != Math.Truncate(_double))
            return safe ? null : LSONUtil.Throw<long?>(new InvalidCastException("Only integer values can be converted to long."));

        if (_double < long.MinValue || _double > long.MaxValue)
            return safe ? null : LSONUtil.Throw<long?>(new InvalidCastException("Cannot cast to long because the value exceeds the representable range."));
